...
public class Room
{
    ...
    public HashSet<Vector2Int> NarrowTiles { get; set; } = new HashSet<Vector2Int>();
    ...
    public HashSet<Vector2Int> EnemiesInTheRoomPos { get; set; } = new HashSet<Vector2Int>();

    public List<Vector2Int> RoomAccesibilityValidation { get; set; } = new List<Vector2Int>();
    public List<Vector2Int> RoomEnemyValidation { get; set; } = new List<Vector2Int>();
